...
Spaz.Prefs.changeMethods = {
	...
	'services-twitpic-sharepassword': {
		setUI: function(value) {
			// alert('setUI services-twitpic-sharepassword:'+value);
			$('#services-twitpic-sharepassword').attr('checked', value);
			// alert('setUI services-twitpic-sharepassword:'+$('#services-twitpic-sharepassword').attr('checked'));
		},
		check: function() {			
			Spaz.Prefs.set('services-twitpic-sharepassword', Boolean(Spaz.Prefs.get('services-twitpic-sharepassword')));
			// alert('check services-twitpic-sharepassword:'+Spaz.Prefs.get('services-twitpic-sharepassword'));
		}
	},
